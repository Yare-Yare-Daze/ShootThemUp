...
FLinearColor ASTUGameModeBase::DetermineColorByTeamID(int32 ID) const
{
    if(ID - 1 < GameData.TeamColors.Num())
    {
        return GameData.TeamColors[ID - 1];
    }
    UE_LOG(LogSTUGameModeBase, Warning, TEXT("No color for team id: %i, set to default: %s"), ID, *GameData.DefaultTeamColor.ToString());
